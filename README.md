...
циклов. Полный автоматический live-сценарий пока не подключён; режим по умолчанию
...
Не включайте автоматический `BOOKING_MODE=live` до завершения worker-шагов 16–17
